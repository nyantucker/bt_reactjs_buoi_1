      ...
      return (
        <div key={index} className="col-lg-6 col-xl-4 mb-5" style={{fontSize:"15px"}}>
          ...
          <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                <div style={{height: '4rem', width: '4rem', fontSize: '2rem', justifyContent: 'center', position: 'absolute', top: 0, left: '50%', transform: 'translateX(-50%)'}} className="feature bg-primary bg-gradient text-white rounded-3 mb-4 mt-n4">
                    <i className={item} />
          </div>
